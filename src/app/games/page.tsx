      ...
      <div className="px-8 pt-20 pb-8">
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="mb-8 text-center">
            <h1 className="text-5xl font-black text-black mb-3">Quiz Game</h1>
            <p className="text-black/70 text-lg font-bold">
              Test your knowledge and earn XP!
            </p>
          </div>

          {/* Level Display & Leaderboard - Only show when not in quiz */}
          {!selectedMaterial && (
            <div className="mb-8 max-w-5xl mx-auto space-y-4">
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className={`inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-yellow-300 to-orange-300 text-black font-black text-lg border-[3px] border-black rounded-xl shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] hover:shadow-[7px_7px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5 transition-all ${
                    showLeaderboard ? "ring-2 ring-black" : ""
                  }`}
                >
          ...
          {selectedMaterial ? (
            ...
            <TopicSelector userId={userId} onSelectTopic={handleSelectTopic} />
          )}
        </div>
      </div>
    </div>
